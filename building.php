...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>ЖК Лебединий - Будівництво | Ревуцького 40</title>
  ...
  <body>
    ...
    <section class="windowView">
      ...
      <div class="section_gallery1">
        <!-- классы слайдов дублируются с главной страницы раздела "Галерея" -->
      ...
      <div class="wrapper wrapper_pager">
        <div class="gallery_pager1">
          <!-- классы мини-слайдов дублируются с главной страницы раздела "Галерея" -->
          ...
          <a data-slide-index="7" href="" class="gal_min_item"><img src="/img/views/view-1.jpg" /></a>
